...
export function Notification({ data, onClose }: Props) {
  ...
  function handleOnPress(){ 
    if(data.launchURL){ // Tratando Deep Linking com App em primeiro plano
  ...
  return (
    <Pressable onPress={handleOnPress} w="full" pt={12} p={4} bgColor="gray.200" position="absolute" top={0}>
      <HStack 
